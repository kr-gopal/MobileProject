...
public class MobileApplication implements CommandLineRunner {
	...
	public void run(String... strings) throws Exception {
		...
		Mobile mobile18 = new Mobile("Mobile18", "Samsung", "4G LTE", 4, 2, "Android", true, true);
		mobileService.saveMobile(mobile18);
		Mobile mobile19 = new Mobile("Mobile19", "LG", "4G", 4, 2, "Android", true, true);
		mobileService.saveMobile(mobile19);
